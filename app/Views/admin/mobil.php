                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="modalTambahAkunLabel">Tambah Mobil Tanki</h5>
                                ...
                                <div class="modal-body">
                                    ...
                                    <form action="" method="POST" autocomplete="off">
                                        ...
                                        <div class="mb-3">
                                            <label for="plat" class="form-label">Plat <span
                                                    class="text-danger">*</span></label>
                                            <input type="number" class="form-control" id="plat" name="plat"
                                                placeholder="Masukkan plat mobil" required />
                                        </div>
                                        <div class="mb-3">
                                            <label for="kapasitas" class="form-label">Kapasitas Tanki <span
                                                    class="text-danger">*</span></label>
                                            <div class="input-group">
                                                <input type="number" class="form-control" id="kapasitas"
                                                    name="kapasitas" placeholder="masukkan dalam satuan Liter" required
                                                    min="0" step="1" />
                                                <input type="text" class="form-control" value="Liter"
                                                    placeholder="Liter" disabled />
                                            </div>
                                        </div>
                                        <div class="mb-3">
                                            <label for="berat-kendaraan" class="form-label">Berat Kendaraan
                                                Kosong</label>
                                            <div class="input-group">
                                                <input type="number" class="form-control" id="berat-kendaraan"
                                                    name="berat-kendaraan" placeholder="masukkan dalam satuan Liter"
                                                    required min="0" step="1" />
                                                <input type="text" class="form-control" value="Kg" placeholder="Kg"
                                                    disabled />
                                            </div>
                                        </div>
                                        <div class="mb-3">
