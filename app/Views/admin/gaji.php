...
<?= self::section('css'); ?>
<link rel="stylesheet" href="<?=base_url('/css/admin/style_gaji.css')?>" />
<?= self::endSection(); ?>
    ...
    <div class="container mb-5 mt-3 rounded-5 p-5 pt-3 shadow" style="background-color: #fefefe;">
        ...
        <header class="mt-3">
            <div class="row justify-content-between">
                <h2 class="text-center mb-4 fw-semibold text-oren fs-2 text-shadow"><i
                        class="bi bi-envelope-check-fill"></i> Gaji Sopir</h2>
                <div class="col mt-2">
                    <div class="row mb-2 mt-2 d-flex justify-content-between">
                        <div class="col-md-4">
                            <div class="rounded-pill mx-2 shadow-sm row rounded bg-white px-1 overflow-hidden">
                                ...
                                <div class="col-9 bg-white text-dark-emphasis">
                                    <h6 class="fw-bold mt-2">Total Sopir</h6>
                                    <span id="total-harga" class="fs-4 fw-bold">2</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <form class="mb-3 d-flex flex-column" id="date-form" action="" method="POST">
                                <div class="m-auto">
                                    <label for="tanggal text-center">Pilih Bulan : </label>
                                </div>
                                <input type="month" value="2023-05" max="" id="tanggal-awal" name="tanggal-awal"
                                    class="inputTanggal ms-2 text-center" lang="id-ID" name="start-date" />
                                <button class="ms-2 rounded-1 btn btn-danger fs-09 px-2" name="submit-date-form"
                        ...
                        <div class="col-md-4">
                            <div class="rounded-pill mx-2 shadow-sm row rounded bg-white px-1 overflow-hidden">
                                ...
                                <div class="col-9 bg-white text-dark-emphasis">
                                    <h6 class="fw-bold mt-2">Rata-Rata Gaji</h6>
                                    <span id="total-harga" class="fs-4 fw-bold">2</span>
                                </div>
                            </div>
                        </div>
...
<?= self::endSection(); ?>
<?= self::section('js'); ?>
<script src="<?= base_url('/js/admin/script_gaji.js') ?>"></script>
<?= self::endSection(); ?>